...
public class ProfesorServices {
    ...
    public ArrayList<Evaluacion> listarEvaluacionesXClassroom(@WebParam(name="codigo")String codigoClassroom){
        return DBController.listarEvaluacionesXClassroom(codigoClassroom);
    }
}
